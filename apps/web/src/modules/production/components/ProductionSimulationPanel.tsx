...
import type { ProductionSimulation } from '../production.types';
...
export function ProductionSimulationPanel({
  simulation,
}: {
  ...
  return (
    <section className="rounded-[30px] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(239,247,255,0.78))] p-4 shadow-[0_12px_30px_rgba(79,143,212,0.06)]">
      ...
      <div className="mt-5 rounded-[24px] bg-[#EAF5FF] p-4">
      ...
      >
        ...
        <span className="text-[1rem] font-black">Ouvir orientacao</span>
      </button>
    </section>
  );
}