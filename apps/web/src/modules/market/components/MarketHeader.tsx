...
export function MarketHeader({ selectedStep }: { selectedStep: MarketStep }) {
  ...
  return (
    <section className="rounded-[30px] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.90),rgba(255,249,241,0.78))] p-4 shadow-[0_12px_28px_rgba(91,64,37,0.05)]">
      <div className="flex items-center justify-between gap-3">
        <div className="inline-flex items-center gap-2 rounded-full bg-[#FFF0D0] px-3 py-1 text-[0.68rem] font-black uppercase tracking-[0.14em] text-[#C88919]">
